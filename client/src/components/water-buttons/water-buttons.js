  ...
  return (
    <React.Fragment>
      <div className="w-100 d-flex justify-content-around">
        <button className="h2" onClick={() => createDateEntry(username, 150, setWaterLevel)}>150 ml</button>
        <button className="h2" onClick={() => createDateEntry(username, 250, setWaterLevel)}>250 ml</button>
        <button className="h2" onClick={() => createDateEntry(username, 350, setWaterLevel)}>350 ml</button>
      </div>
